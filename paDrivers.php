...
<nav class="navbar navbar-header navbar-fixed-top" style="margin-bottom: 0;">
  <div class="row" style="height: 100%; margin: 0">
      ...
      <div class="col-sm-2" style="text-align: center; float: right">
                <h5 class="account dropbtn" >Drivers Credit </h5>
      </div>
      </div>
  </div>
</nav>
          ...
          <h4 class="credits">Add credits</h4>
            <form method="POST" action="addCredit.php">
                <div class="input-groups">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control input-lg" id="old-balance" step="0.01"  readonly="readonly" placeholder="Old Driver Balance">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control input-lg" id="amountEntered" name="amount" step="0.01" required="required" placeholder="New Driver Balance">
                  </div>
                </div>
                <div class="form-group">
