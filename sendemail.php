...
// }else{
//     $signaturePOST = '<img src="http://ods.gothong.com/pickapp_live_ws/pickapp_ws/'.$signature.'"/>';
// }
...
<table id="third">
    <tr>
        <td rowspan="2"><img src="cid:drheader" width="330" height="50"></td>
...
<table id="third">
    ...
    <tr>
        ...
        <td rowspan="10"><img alt="Signature not Available!" width="200" height=""></td>
    </tr>
